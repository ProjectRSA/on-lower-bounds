...
echo UserInstances/QoT_Instances/PAPER_kShortest4/${tab1[$SLURM_ARRAY_TASK_ID]}
./exe1 UserInstances/QoT_Instances/PAPER_kShortest4/${tab1[$SLURM_ARRAY_TASK_ID]} UserInstances/QoT_Instances/PAPER_kShortest4/${tab1[$SLURM_ARRAY_TASK_ID]}.txt 4