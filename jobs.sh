...
echo UserInstances/QoT_Instances/${tab1[$SLURM_ARRAY_TASK_ID]}
./exe UserInstances/QoT_Instances/${tab1[$SLURM_ARRAY_TASK_ID]} UserInstances/QoT_Instances/${tab1[$SLURM_ARRAY_TASK_ID]}.txt 4