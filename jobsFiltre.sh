...
echo UserInstances/QoT_Instances/PAPER_EdgePathFiltre/${tab1[$SLURM_ARRAY_TASK_ID]}
./exe2 UserInstances/QoT_Instances/PAPER_EdgePathFiltre/${tab1[$SLURM_ARRAY_TASK_ID]} UserInstances/QoT_Instances/PAPER_EdgePathFiltre/${tab1[$SLURM_ARRAY_TASK_ID]}.txt 1